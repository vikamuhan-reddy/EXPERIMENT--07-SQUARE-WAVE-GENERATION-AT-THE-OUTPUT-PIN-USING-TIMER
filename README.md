...
static void MX_TIM2_Init(void)
{
  ...
  sConfigOC.Pulse = 500; // clock pulse need to change for each one (500,700,900) 
...
## FOR PULSE AT 500
![WhatsApp Image 2025-05-19 at 09 47 02_54c13261](https://github.com/user-attachments/assets/db80706c-2bc1-48d1-ab68-a8f23cd445a3)
...
```          
## FOR PULSE AT 700
![WhatsApp Image 2025-05-19 at 09 44 29_f7b17f1a](https://github.com/user-attachments/assets/e22ba812-ef26-49a1-889a-31fb75dd7e62)
...
DUTY CYCLE = TON/(TON+TOFF)
           = 0.70
DUTY CYCLE (IN PERCENTAGE) = 0.70 * 100
           = 70% 
```
## FOR PULSE AT 900
![WhatsApp Image 2025-05-19 at 09 43 21_f1d4d0ee](https://github.com/user-attachments/assets/7014a9ed-123a-4d27-b977-9b2f02db32fa)
...
DUTY CYCLE = TON/(TON+TOFF)
           = 0.000054/(0.00006)
           = 0.90
DUTY CYCLE (IN PERCENTAGE) = 0.90 * 100 
           = 90%
```
